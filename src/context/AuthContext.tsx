...
const PRELOADED_ADMIN_PROFILE: UserProfile = {
  ...
  avatarUrl: DEFAULT_CREATOR_AVATARS[0]?.url || "/main/public/avatars_128/cyber.png",
  theme: "midnight",
        ...
        if (fbUser) {
          ...
          if (!prof && !activeUser) {
            const initialProf: UserProfile = {
              ...
              email: fbUser.email || "",
              avatarUrl: fbUser.photoURL || DEFAULT_CREATOR_AVATARS[0]?.url || "/main/public/avatars_128/cyber.png",
              theme: "midnight",
              defaultEpisodeDuration: 90,
